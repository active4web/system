...
class Site extends MX_Controller {
    ...
    function index() {
		...
		$data_contant['home_products']=$this->db->order_by('id','desc')->limit(4)->get_where('product',array('view'=>'1'))->result()
		; 
		$data_contant['team_work']=$this->db->order_by('id','desc')->limit(12)->get_where('team_work',array('view'=>'1'))->result()
		; 
