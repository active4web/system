                                            ...
                                            foreach($results as $data) {
												...
												switch($type){
													...
													case 1:
													  ...
													  break;
													  case 2:
													  $type="<span class='label label-sm label-success'>Casher</span>";
													  break;
													default:
													  break; 
												}
												...
												$total_sales=$this->db->get_where('final_order',array("id_admin"=>$data->id))->result();
                                        ?>
											<tr class="odd gradeX">
												<td>
													<label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
												...
												<td><a href="<?=base_url()?>pos/statistics/casher?id=<?= $data->id;?>"><?=count($total_sales);?></a></td>
												<td><?=$type;?></td>
												<td>
												...
												<td>
													<div class="btn-group">
														...
														<ul class="dropdown-menu pull-left" role="menu">
															...
															<li><a href="<?php echo base_url()?>pos/System_cp/update_admin?id_type=<?php echo $data->id;?>"><i class="fa fa-pencil"></i> <?=lang('edit');?> </a></li>
															<li><a href="<?php echo base_url()?>pos/System_cp/delete_admin?id_type=<?php echo $data->id;?>"><i class="fa fa-remove"></i> <?=lang('remove');?> </a></li>
...
var data={id:id};
			$.ajax({
				url: '<?php echo base_url("pos/System_cp/check_view_teamwork") ?>',
                type: 'POST',
                data: data,				
