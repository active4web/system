			...
			<div class="page-content-wrapper">
				...
				<div class="page-content">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<span class="active"><?=lang('maincategory');?></span>
						</li>
					</ul>
					<!-- END PAGE BREADCRUMB -->
					...
					<div class="row">
							...
							<div class="portlet light bordered">
								<div class="portlet-title">
									<div class="caption font-dark">
										...
										<span class="caption-subject bold uppercase"><?=lang('maincategory');?></span>
									</div>
								</div>
						...
						$tatal_pharm=$this->db->get_where('product',array("id_cat"=>$data->id))->result();	
                                        ?>
											<tr class="odd gradeX">
												<td>
													<label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
												...
												<td>
													<div class="btn-group">
														...
														<ul class="dropdown-menu pull-left" role="menu">
															...
															<li><a href="<?php echo base_url()?>pos/category/update_category?id_type=<?php echo $data->id;?>"><i class="fa fa-pencil"></i> <?=lang('edit');?> </a></li>
															<li><a href="<?php echo base_url()?>pos/category/delete_category?id_type=<?php echo $data->id;?>"><i class="fa fa-remove"></i> <?=lang('remove');?> </a></li>
...
$(document).ready(function(e) {
    $(".addbutton").click(function(e) {
        window.location.assign("<?= base_url()?>pos/category/add_category");
    });
});
</script>
...
var data={id:id};
			$.ajax({
				url: '<?php echo base_url("pos/category/view") ?>',
                type: 'POST',
                data: data,				
