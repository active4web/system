		...
		<div class="page-container">
			...
			<div class="page-content" style="min-height: 1261px;">
                    ...
                    <ul class="page-breadcrumb breadcrumb">
						...
						<li>
                        <a href="<?=$url.'admin/category';?>"><?=lang("maincategory")?></a>
                        <i class="fa fa-circle"></i>
						</li>
                        <li>
                                    ...
                                    <div class="tab-pane active" id="tab_5">
                                        ...
                                        <div class="portlet light bordered form-fit">
                                            ...
                                            <div class="portlet-body form">
                                                <!-- BEGIN FORM-->
    <form action="<?=$url;?>pos/category/edit_action" class="form-horizontal form-bordered"  method="post" enctype="multipart/form-data">
											        ...
											        <div class="form-body">
														...
														<div class="col-md-2"></div>
                                                            ...
                                                            <span class="help-block"><?=lang("maincategory");?></span>
                                                                <input type="text"  value="<?= $food_name?>" placeholder="<?=lang("maincategory");?>" class="form-control" name="food_name">
