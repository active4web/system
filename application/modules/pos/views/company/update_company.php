		...
		<div class="page-container">
			...
			<div class="page-content" style="min-height: 1261px;">
                    ...
                    <ul class="page-breadcrumb breadcrumb">
						...
						<li>
                        <a href="<?=$url.'admin/company';?>"><?=lang("company")?></a>
                        <i class="fa fa-circle"></i>
						</li>
                        <li>
                                    ...
                                    <div class="tab-pane active" id="tab_5">
                                        ...
                                        <div class="portlet light bordered form-fit">
                                            ...
                                            <div class="portlet-body form">
                                                <!-- BEGIN FORM-->
    <form action="<?=$url;?>pos/company/edit_action" class="form-horizontal form-bordered"  method="post" enctype="multipart/form-data">
                                               <input type="hidden" name="id" value="<?= $id?>">
											        ...
											        <div class="form-body">
														...
														<div class="col-md-2"></div>
                                                            <div class="col-md-8">
                                                            <span class="help-block"><?=lang("company");?></span>
                                                                <input type="text"  value="<?= $company_name?>" placeholder="<?=lang("company");?>" class="form-control" name="company_name">
