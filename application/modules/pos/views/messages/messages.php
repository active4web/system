						...
						<div class="col-md-12">
							...
							<div class="portlet light bordered">
								...
								<div class="portlet-body">
									...
									<form action="<?=$url;?>admin/products/delete_message" method="POST" id="form">
												...
												<td>
													<div class="btn-group">
														...
														<ul class="dropdown-menu pull-left" role="menu">
															<li><a href="<?php echo base_url()?>admin/delete_message?id=<?= $data->id_message;?>"><i class="fa fa-remove"></i> <?=lang('remove');?> </a></li>
...
var data={id:id};
			$.ajax({
				url: '<?php echo base_url("admin/check_view_message") ?>',
                type: 'POST',
                data: data,				
