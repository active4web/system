			...
			<div class="page-content-wrapper">
				...
				<div class="page-content">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<span class="active"><?= lang("Invoice");?></span>
						</li>
					</ul>
					<!-- END PAGE BREADCRUMB -->
							...
							<div class="portlet light bordered">
								<div class="portlet-title">
									<div class="caption font-dark">
										...
										<span class="caption-subject bold uppercase"><?= lang("Invoice");?></span>
									</div>
								</div>
...
<?php
if($maindata->taxi!=""&&$maindata->taxi!=0){
?>
<tr class="odd gradeX">
...
<?php } ?>
<?php
if($maindata->service!=""&&$maindata->service!=0){
?>
<tr class="odd gradeX">
...
<a href="<?=DIR?>pos/orders/print_pdf?id_order=<?=$this->input->get("id_order");?>" target="_blank" class="return_black">
<button type="submit" class="btn green">
<i class="fa fa-check"></i><?=lang("print")?></button></a>
<a href="<?= base_url()?>pos/orders/delete_order?ordercode=<?= $this->input->get("id_order"); ?>"><button id="sample_editable_1_2_new" class="btn sbold red delbutton"><?=lang("cancel");?> <i class="fa fa-remove"></i></button>
</a>
</div>
