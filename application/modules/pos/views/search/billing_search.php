...
$end_time=$this->input->post('end_time');
		$start_time=$this->input->post('start_time');
			...
			$array="";
if($start_time!=""){
 $this->db->where(array('view'=>'1',"DATE_FORMAT(date,'%Y-%m-%d')>="=>$start_time));
}
if($end_time!=""){

 $this->db->where(array('view'=>'1',"DATE_FORMAT(date,'%Y-%m-%d')<="=>$end_time));
	}
if($end_time!=""&&$start_time!=""){

 $this->db->where(array('view'=>'1',"DATE_FORMAT(date,'%Y-%m-%d')<="=>$end_time,"DATE_FORMAT(date,'%Y-%m-%d')>="=>$start_time));
	}

$query = $this->db->get();
 $total_price=$query->row()->total_price;
?>
<!DOCTYPE html>
			...
			<div class="page-content-wrapper">
				...
				<div class="page-content">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<span class="active"><?=lang("Billing")?></span>
						</li>
					</ul>
					<!-- END PAGE BREADCRUMB -->
							...
							<div class="portlet light bordered">
								<div class="portlet-title">
									<div class="caption font-dark">
										...
										<span class="caption-subject bold uppercase"><?=lang("Billing")?>&nbsp&nbsp(<?= $total_price?>)EGP</span>
									</div>
								</div>
...
<div class="btn-group">
<form action="<?=$url;?>pos/search/billing_search" method="POST" id="form">
    <div class="btn-group">
...
<div class="col-md-12">
	...
	<table class="table table-striped table-bordered table-hover table-checkable order-column" style="margin-top:20px" id="sample_1_2">
        ...
        $name_cat=get_tab_row('team_work',array('id'=>$id_customer),'title');
								...
								<td><?= $date_code."-".$order_code;?></td>
                                               ...
                                               <td> <?= $total_price?> </td>
                                                ...
                                                <td>
			<a title="<?=lang('content');?>" href="<?= DIR?>pos/search/billing_details?id=<?= $data->id;?>"><?=lang('content');?>
