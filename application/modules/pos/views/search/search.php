...
$this->db->select_sum('limit_value');
  $this->db->from('team_work');
  $query = $this->db->get();
   $limit_value=$query->row()->limit_value;
   
   $this->db->select_sum('count_clients');
  $this->db->from('team_work');
  $query_c = $this->db->get();
   $count_clients=$query_c->row()->count_clients;
							...
							<div class="portlet light bordered">
								<div class="portlet-title">
									<div class="caption font-dark">
										...
										<span class="caption-subject bold uppercase"> <?= lang("teamwork");?> <?php if($limit_value>0){?>
										<?= lang("limit");?>:<?= $limit_value ;?> <?php }?>&nbsp&nbsp<?php if($count_clients>0){?>
										<?= lang("Total_sales");?>:<?= $count_clients;?><?php }?></span>
									</div>
								</div>
