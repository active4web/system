...
<div class="container">
					<div class="row">
						<div class="col-md-6 col-sm-6 col-xs-6">
							<div class="title">
								<h3><?php echo lang('offers_page'); ?></h3>
							</div>
						</div>
						<div class="col-md-6 col-sm-6 col-xs-6">
							<ol class="breadcrumb text-center">
							  <li><a href="<?= DIR?>site"><?php echo lang('home_page'); ?></a></li>
							  <li class="active"><a href="#"><?php echo lang('offers_page'); ?></a></li>
							</ol>	
						</div>
					</div>
				</div>		
				...
				<div class="row">
					...
					<?php if($result_amount>0){
						...
						<div class="col-md-3 col-sm-3 col-xs-6">
								<a href="<?= DIR ?>site/offers/offers_details/<?= $prod->id;?>">
									<div class="pro">
									<img class="img-responsive center-block" src="<?= DIR_DES_STYLE?>offers/<?= $prod->img;?>">
