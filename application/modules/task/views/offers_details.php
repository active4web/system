					...
					<div class="row">
						...
						<div class="col-md-6 col-sm-6 col-xs-6">
							<ol class="breadcrumb text-center">
							  ...
							  <li class="active"><a href="<?= DIR?>site/offers/offers"><?php echo lang('offers_page'); ?></a></li>
							</ol>	
						</div>
					</div>
				</div>		
			...
			<div class="pro-details">
				<div class="container">
					...
					<?php   $count++; } ?>
						...
						<img class="img-responsive center-block" src="<?= DIR_DES_STYLE?>gallery/offers/<?= $gallery->image;?>">
									</div>
										<?php }?>
						...
						<img class="img-responsive center-block" src="<?= DIR_DES_STYLE?>offers/<?= $product_details->img;?>">
									</div>
								</div>
								<?php }?>
