					...
					<div class="row">
						...
						<div class="col-md-6 col-sm-6 col-xs-6">
							<ol class="breadcrumb text-center">
							  ...
							  <li class="active"><a href="<?= DIR?>site/stories/success_stories"><?php echo lang('success_stories_page'); ?></a></li>
							</ol>	
						</div>
					</div>
				</div>		
			...
			<div class="pro-details">
				<div class="container">
					...
					<?php   $count++; } ?>
						...
						<img class="img-responsive center-block" src="<?= DIR_DES_STYLE?>gallery/stories/<?= $gallery->image;?>">
									</div>
										<?php }?>
						...
						<img class="img-responsive center-block" src="<?= DIR_DES_STYLE?>stories/<?= $product_details->img;?>">
									</div>
								</div>
								<?php }?>
