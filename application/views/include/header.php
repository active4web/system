				...
				<div class="row">
					...
					<div class="col-md-6 col-sm-6 col-xs-12">	
						<div class="cont">
							...
							<li><a href="tel:<?= $site_info->footer_phone;?>" class="Blondie"><?= $site_info->header_phone?> <i class="fa fa-phone phonehead"></i></a></li> 
					...
					<!-- Brand and toggle get grouped for better mobile display -->
						...
						<div class="collapse navbar-collapse" id="axit-nav">
						   <ul class="nav navbar-nav <?= $navbar; ?>">
							...
							<li class="<?php if( $curt == 'products' ){ echo 'active'; } ?>"><a href="<?= DIR ?>site/product/products"><?php echo lang('product_page'); ?></a></li>
							<li class="<?php if( $curt == 'doctors' ){ echo 'active'; } ?>"><a href="<?= DIR ?>site/doctors/team_work"><?php echo lang('team_page'); ?></a></li>
							<li class="<?php if( $curt == 'offers' ){ echo 'active'; } ?>"><a href="<?=DIR ?>site/offers/offers"><?php echo lang('offers_page'); ?></a></li>
							<li class="<?php if( $curt == 'bmi' ){ echo 'active'; } ?>"><a href="<?= DIR ?>site/pages/bmi"><?php echo lang('bmi_page'); ?></a></li>
							<li class="<?php if( $curt == 'success_stories' ){ echo 'active'; } ?>"><a href="<?= DIR ?>site/stories/success_stories"><?php echo lang('success_stories_page'); ?></a></li>
							<li class="<?php if( $curt == 'fq' ){ echo 'active'; } ?>"><a href="<?= DIR ?>site/faq/help"><?php echo lang('faq_page'); ?></a></li>
